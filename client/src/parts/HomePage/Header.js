...
export default function Header({ theme, position }) {
  ...
  const [ToogleMainMenu, setToogleMainMenu] = useState(false)
      ...
      <div className="container mx-auto py-5">
        <div className="flex flex-stretch items-center">
          ...
          <div className="w-auto">
            <ul
              className={["fixed bg-white inset-0 flex flex-col invisible items-center justify-center md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center", ToogleMainMenu ? "opacity-100 z-30 visible" : "invisible opacity-0"].join(" ")}
              id="menu"
            >
            ...
            <ul className="items-center flex">
              <li className="ml-6 block md:hidden">
                <button
                  ...
                  className={["flex z-50 items-center justify-center w-8 h-8 text-black md:text-black focus:outline-none", ToogleMainMenu ? "fixed top-0 right-0" : "relative", theme === "white" ? "text-black md:text-black" : "text-white md:text-black"].join(" ")}
