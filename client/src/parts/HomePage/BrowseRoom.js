...
export default function BrowseRoom() {
  ...
  const ratioClassNames = {
    ...
    meta: {
      ...
      "2/2": "inset-0 md:bottom-auto flex justify-center md:item-center flex-col pl-48 md:pl-10 pt-0 md:pt-12",
      "2/3": "inset-0 md:bottom-auto flex justify-center md:item-center flex-col pl-48 md:pl-10 pt-0 md:pt-12",
    }
  }
    ...
    <section className="flex bg-gray-100 py-16 px-4" id="browse-the-room">
      <div className="container mx-auto">
        ...
        <div className="grid grid-rows-2 grid-cols-9 gap-4">
          {
            isLoading ? <LoadingBrowseRoom ratio={ratioClassNames} /> :
